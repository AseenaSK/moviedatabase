...
class SingleMovieDetails extends Component {
  ...
  getMovieDetails = async () => {
    ...
    const {params} = match
    const {id} = params
    const getMovieApi = `https://api.themoviedb.org/3/movie/${id}?api_key=285367697c367d29bf5a46edbf8fce2c&language=en-US`
    const getCastApi = `https://api.themoviedb.org/3/movie/${id}/credits?api_key=285367697c367d29bf5a46edbf8fce2c&language=en-US`
